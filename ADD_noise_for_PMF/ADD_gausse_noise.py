...
# folder_path = r'D:\PSH-Learning\172.24.97.7_character\172.24.97.7_PSH\ADD_noise\data_PMF\test'   # for PMF_matster
# output_folder_path = r'D:\PSH-Learning\172.24.97.7_character\172.24.97.7_PSH\ADD_noise\data_PMF_noise\gausse_noise\0.2'  # for PMF_matster .。。。。这里的0表示此时加入的噪声的强度为0.
...
output_folder_path = r'D:\PSH-Learning\172.24.97.7_character\172.24.97.7_PSH\ADD_noise_1\PMF_one-shot-classification_noise\gausse_noise\0.2'  # for PMF_matster .。。。。这里的0表示此时加入的噪声的强度为0.
...
for folder_name in os.listdir(folder_path):
    ...
    for file_name in os.listdir(folder_dir):
        ...
        # # 加入高斯噪声
        gaussian_out= gaussian_noise(img, 0,0.2)

        #加入椒盐噪声
        #saltpepper_out, _ = saltpepper_noise(img,0.03)   # 0.03：表示噪声比例。改变这个就可以改变噪声的强度。
